...
public class BloodPressureActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pb_lower=(EditText)findViewById(R.id.lowerBound);
        pb_date=(TextView)findViewById(R.id.date_chooser);
        pb_cancel=(Button)findViewById(R.id.cancel_btn_bp);
        pb_save=(Button)findViewById(R.id.save_btn_bp);
        ...
        pb_save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(!TextUtils.isEmpty(a)  &&  !TextUtils.isEmpty(b)  &&  c!="Choose Date"){
