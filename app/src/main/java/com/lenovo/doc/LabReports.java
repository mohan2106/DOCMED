...
public class LabReports extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        name.setHint("Laboratory Name");
        add.setHint("Laboratory Address");
        reason.setHint("Category of lab report (ex. Blood test)");
        ...
        date.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                dbg=new DatePickerDialog(LabReports.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
        ...
        pb.show();
        firestore.collection("USERS").document(mAuth.getUid()).collection("HealthBook").document("LabReport").collection("India").get().addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
            @Override
            public void onComplete(@NonNull Task<QuerySnapshot> task) {
                if(task.isSuccessful()){
                    ...
                    Toast.makeText(LabReports.this, task.getException().getMessage(), Toast.LENGTH_SHORT).show();
                }
                pb.dismiss();
            }
        });
        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if((imageUri != null) && (!TextUtils.isEmpty(dr_name)) && (!TextUtils.isEmpty(dr_address)) && (!TextUtils.isEmpty(dr_reason)) && !(date.getText().toString().equals("Choose Date")) ){
                        ...
                        public void onComplete(@NonNull Task<UploadTask.TaskSnapshot> task) {
                            user_profile.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                                ...
                                public void onSuccess(Uri uri) {
                                    ...
                                    //data.put("id",id);
                                    firestore.collection("USERS").document(mAuth.getUid()).collection("HealthBook").document("LabReport").collection("India").add(data).addOnCompleteListener(new OnCompleteListener<DocumentReference>() {
                                        @Override
                                        public void onComplete(@NonNull Task<DocumentReference> task) {
                                            if(task.isSuccessful()){
                                                Toast.makeText(LabReports.this, "Prescription uploaded", Toast.LENGTH_SHORT).show();
                                            }
                                            else{
                                                Toast.makeText(LabReports.this, task.getException().getMessage(), Toast.LENGTH_SHORT).show();
                                            }
                                ...
                                public void onFailure(@NonNull Exception e) {
                                    Toast.makeText(LabReports.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                                }
                            });
                    ...
                    Toast.makeText(LabReports.this, "Enter all fields", Toast.LENGTH_LONG).show();
                }
            }
        });
